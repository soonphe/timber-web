<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      />
      <el-select v-model="listQuery.status" placeholder="请选择状态类型" class="filter-item" clearable @clear="clearType">
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$store.dispatch('user/clearRole')
      this.$router.push({
        path: '/sysRole/add'
      })
    },
    put(row) {
      this.$store.dispatch('user/saveRole', row)
      this.$router.push({
        path: '/sysRole/add'
      })
    },
